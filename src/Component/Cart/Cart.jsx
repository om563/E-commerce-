  ...
  {cartItems? <div className="bg-main-light p-4">
      <div className="d-flex justify-content-between my-3 ">
        ...
        <div>
          ...
          <h2 className="h5  fw-bold">total number of items: <span className="text-main">{cartItems?.numOfCartItems}</span></h2>
        </div>
      </div>
    ...
    <div key={product._id} className="row py-3 border border-bottom border-top-0 border-end-0 border-start-0 bg-main-light">
      ...
      {cartItems?<div className="d-flex justify-content-center my-2">
            <button onClick={()=>deleteUserCart()} className="btn btn-outline-success text-dark p-2 px-3 fw-bolder">Clear Your Cart</button>
        </div>:""}
